		...
		<>
			<div className="content">
				<div id="formulaire" className="effect">
					...
					<p className="mb-2">
						Vous souhaitez réaliser une webApp ou une application
						mobile ? Réaliser un parcours design UI UX ? Refonte
						d'une charte ? Décrivez-le en quelques lignes. Je vous
						répondrai.
					</p>
					...
					<form onSubmit={handleSubmit}>
						...
						<Input
							...
							onChange={handleChangeInput}
							className={
								errorEmail === true ? "error-form" : null
							}
						/>
						<Textarea
							label="Votre projet"
							...
							onChange={handleChangeInput}
							className={
								errorTextarea === true ? "error-form" : null
							}
						/>
						<Input type="submit" />
					</form>
